...
namespace DIO_Series
{
    class Program
    {
        ...
        private static void VisualizarSerie()
        {
            ...
            var serie = repositorio.retornaId(indicaSerie);
        ...
        private static void ListarSeries()
        {
            ...
            {
                var exlcuido = serie.retornarExcluido();

                Console.WriteLine("#ID {0}: - {1} - {2^}", serie.retornaId(), serie.retornaTitulo(), (exlcuido ? "Excluído" : ""));
            }
        }
